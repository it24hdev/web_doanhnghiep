...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <a href="{{route('role.list')}}" class="btn btn-primary">Danh sách quyền quản trị</a>
    </div>
                ...
                <form method="POST" action="{{ route('role.store') }}">
                    ...
                    <div class="intro-x mt-8">
                        ...
                        <input type="text"
                            ...
                            placeholder="Nhập tên quyền" name="name" id="name" value="{{ old('name') }}" required
                        ...
                        <input type="text"
                            class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-2 mb-3"
                            placeholder="Mô tả thêm về vai trò của quyền" name="desc" id="desc" value="{{ old('desc') }}"
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button type="submit" name="btn_add" value="add"
                            class="btn btn-primary py-3 px-4 w-full lg:w-32 xl:mr-3 align-top">Thêm mới</button>
                    </div>
                </form>
            </div>
        </div>
