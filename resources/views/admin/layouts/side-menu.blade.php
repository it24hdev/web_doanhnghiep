...
<nav class="side-nav" style="position: relative;">
    ...
    <ul>
        ...
        <li>
            <a href="javascript:;" class="side-menu {{ (($module_active == 'user') || ( $module_active == 'role')) ? 'side-menu--active' : '' }}">
            ...
            <ul class="{{ (($module_active == 'user') || ( $module_active == 'role')) ? 'side-menu__sub-open' : '' }}">
