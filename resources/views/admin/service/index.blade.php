    ...
    <div class="grid grid-cols-12 gap-6 mt-5" id="data-table">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            @can('create2',\App\Models\Post::class)
                <a class="btn btn-primary shadow-md mr-2" href="{{route('post2.create')}}">Tạo dịch vụ</a>
            @endcan
            <div class="hidden md:block mx-auto text-gray-600"></div>
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <form id="searchform" name="searchform" action="{{ route('post2.index')}}" class="flex flex-col sm:flex-row sm:items-end xl:items-start" onsubmit="return false">
                    <div class="sm:w-42 2xl:w-full mt-2 sm:mt-0 sm:w-auto box">
                        <div class="w-full relative text-gray-700 dark:text-gray-300">
                            ...
                            <a class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0" href="{{route('post2.index')}}" id='search_btn'><i class="absolute my-auto inset-y-0 right-0" data-feather="search"></i></a>
                        </div>
                    </div>
                </form>
            </div>
        </div>
        @include("admin.service.data-table",["posts"=>$posts])
    </div>
                ...
                <div class="modal-body p-0">
                    <form method="POST">
                        ...
                        <div class="p-5 text-center">
                            ...
                            <div class="text-3xl mt-5">Bạn muốn xoá dịch vụ này?</div>
