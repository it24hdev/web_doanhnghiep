            ...
            <tr class="intro-x" id="{{$post->id}}">
                ...
                <td class="table-report__action w-40">
                    <div class="flex justify-center items-center">
                        @can('update2',\App\Models\Post::class)
                            <a href="{{route('post2.edit',['id'=>$post->id])}}" title="Chỉnh sửa"
                               class="btn btn-sm btn-primary mr-2">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        @endcan
                        @can('delete2',\App\Models\Post::class)
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto uppercase">Chi tiết dịch vụ</h2>
                            @can('update2',\App\Models\Post::class)
                                <div class="sm:w-auto flex mt-4 sm:mt-0">
                                    <a href="{{route('post2.edit',['id'=>$post->id])}}" class="btn btn-primary shadow-md mr-2">Sửa</a>
                                </div>
                            @endcan
...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center" id="pagi">
    ...
    <form action="{{route('post2.index')}}" id="form-limit">
